...
Func GUIMain()
	...
	$Title_Label_1 = GUICtrlCreateLabel("User: ", 10, 191, 100, 12)
	$Title_Label_2 = GUICtrlCreateLabel(".....", 85, 191, 200, 12)
	;GUICtrlSetFont(-1, $sFontSize, $sFontBold, 0, $sFontName, 5)
	$Account_Label_1 = GUICtrlCreateLabel("Account:", 10, 208, 75, 12)
	$Account_Label_2 = GUICtrlCreateLabel(".....", 85, 208, 113, 12)
	$Model_Label_1 = GUICtrlCreateLabel("Device Model:", 10, 225, 75, 12)
	$Model_Label_2 = GUICtrlCreateLabel(".....", 85, 225, 113, 12)
	$Serial_Label_1 = GUICtrlCreateLabel("Device Serial:", 10, 242, 75, 12)
	$Serial_Label_2 = GUICtrlCreateLabel(".....", 85, 242, 113, 12)
	$Battery_Label_1 = GUICtrlCreateLabel("Battery Status:", 10, 259, 75, 12)
	$Battery_Label_2 = GUICtrlCreateLabel(".....", 85, 259, 113, 12)
	$Uptime_Label_1 = GUICtrlCreateLabel("Up Time:", 10, 276, 75, 12)
	$Uptime_Label_2 = GUICtrlCreateLabel(".....", 85, 276, 113, 12)
	$Connection_Label_1 = GUICtrlCreateLabel("Connected by:", 202, 242, 75, 12)
	$Connection_Label_2 = GUICtrlCreateLabel(".....", 277, 242, 113, 12)
	$Wifi_Label_1 = GUICtrlCreateLabel("Wi-Fi SSID:", 202, 259, 75, 12)
	$Wifi_Label_2 = GUICtrlCreateLabel(".....", 277, 259, 113, 12)
	$IP_Label_1 = GUICtrlCreateLabel("IP Address:", 202, 276, 75, 12)
	$IP_Label_2 = GUICtrlCreateLabel(".....", 277, 276, 113, 12)
...
Func DeviceDetails()
	...
	Else
		...
		ConsoleWrite(@ScriptLineNumber & ': ' & $DeviceTitle & @CRLF)
		GUICtrlSetData($Title_Label_2, $DeviceTitle)

		Local $DeviceAccountCommand = Run(@ComSpec & " /c adb -s " & $SerialValue & " shell getprop ro.product.model", "", @SW_HIDE, $STDERR_CHILD + $STDOUT_CHILD)
		ProcessWaitClose($DeviceAccountCommand)
		Local $DeviceAccount = StringStripWS(StdoutRead($DeviceAccountCommand), 8)
		...
		Local $DeviceSerialCommand = Run(@ComSpec & " /c adb -s " & $SerialValue & " shell getprop ro.product.model", "", @SW_HIDE, $STDERR_CHILD + $STDOUT_CHILD)
		...
		Local $DeviceBatteryCommand = Run(@ComSpec & " /c adb -s " & $SerialValue & " shell getprop ro.product.model", "", @SW_HIDE, $STDERR_CHILD + $STDOUT_CHILD)
		ProcessWaitClose($DeviceBatteryCommand)
		Local $DeviceBattery = StringStripWS(StdoutRead($DeviceBatteryCommand), 8)
		GUICtrlSetData($Battery_Label_2, $DeviceBattery)

		Local $DeviceUptimeCommand = Run(@ComSpec & " /c adb -s " & $SerialValue & " shell getprop ro.product.model", "", @SW_HIDE, $STDERR_CHILD + $STDOUT_CHILD)
		ProcessWaitClose($DeviceUptimeCommand)
		Local $DeviceUptime = StringStripWS(StdoutRead($DeviceUptimeCommand), 8)
		GUICtrlSetData($Uptime_Label_2, $DeviceUptime)

		Local $DeviceConnectionCommand = Run(@ComSpec & " /c adb -s " & $SerialValue & " shell getprop ro.product.model", "", @SW_HIDE, $STDERR_CHILD + $STDOUT_CHILD)
		ProcessWaitClose($DeviceConnectionCommand)
		Local $DeviceConnection = StringStripWS(StdoutRead($DeviceConnectionCommand), 8)
		GUICtrlSetData($Connection_Label_2, $DeviceConnection)

		Local $DeviceWifiCommand = Run(@ComSpec & " /c adb -s " & $SerialValue & " shell getprop ro.product.model", "", @SW_HIDE, $STDERR_CHILD + $STDOUT_CHILD)
		ProcessWaitClose($DeviceWifiCommand)
		Local $DeviceWifi = StringStripWS(StdoutRead($DeviceWifiCommand), 8)
		GUICtrlSetData($Wifi_Label_2, $DeviceWifi)

		Local $DeviceIPCommand = Run(@ComSpec & " /c adb -s " & $SerialValue & " shell getprop ro.product.model", "", @SW_HIDE, $STDERR_CHILD + $STDOUT_CHILD)
...
Func GUIChild()
	...
	$SelectedDeviceControlValue = GUICtrlCreateLabel("", 10, 20, 235, 40, $SS_CENTER)
	GUICtrlSetData($SelectedDeviceControlValue, $DeviceTitle & "'s Phone (" & $SerialValue & ")")
	GUICtrlSetFont(-1, $sFontSize, $sFontBold, 0, $sFontName, 5)
	GUICtrlCreateGroup("", -99, -99, 1, 1)
