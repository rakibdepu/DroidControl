...
Global $MainGUI = GUICreate("Scrcpy Helper", 400, 600, 0, 125, $WS_POPUP)
GUISetOnEvent($GUI_EVENT_CLOSE, "Off")
Global $MainGroup = GUICtrlCreateGroup("", 10, 6, 380, 489)
Global $DeviceGroup = GUICtrlCreateGroup("Device List", 20, 18, 360, 118, BitOR($GUI_SS_DEFAULT_GROUP, $BS_CENTER))
Global $DeviceList = GUICtrlCreateListView("#|Device|Connection", 30, 36, 260, 90, BitOR($GUI_SS_DEFAULT_LISTVIEW,$WS_HSCROLL,$WS_BORDER,$BS_CENTER), BitOR($WS_EX_CLIENTEDGE,$LVS_EX_GRIDLINES, $LVS_SHOWSELALWAYS, $LVS_EX_FULLROWSELECT))
...
Global $Refresh = GUICtrlCreateButton("Refresh", 300, 36, 70, 65)
GUICtrlSetOnEvent($Refresh, "Refresh")
Global $ADBKill = GUICtrlCreateButton("Reset", 300, 106, 70, 20, $BS_MULTILINE)
GUICtrlSetOnEvent($ADBKill, "ADBKill")
GUICtrlCreateGroup("", -99, -99, 1, 1)
Global $ADBGroup = GUICtrlCreateGroup("ADB", 20, 142, 360, 48, BitOR($GUI_SS_DEFAULT_GROUP, $BS_CENTER))
Global $GetIP = GUICtrlCreateButton("Get IP", 30, 160, 70, 20, $BS_MULTILINE)
GUICtrlSetOnEvent($GetIP, "GetIP")
Global $GoWireless = GUICtrlCreateButton("Go Air", 300, 160, 70, 20, $BS_MULTILINE)
GUICtrlSetTip(-1, "Enter IP address")
GUICtrlSetOnEvent($GoWireless, "GoWireless")
Global $IPAddress = _GUICtrlIpAddress_Create($MainGUI, 110, 160, 180, 20, -1, 0)
_GUICtrlIpAddress_Set($IPAddress, $WiFiAddressV)
Global $DetailsGroup = GUICtrlCreateGroup("Details", 20, 206, 360, 100, BitOR($GUI_SS_DEFAULT_GROUP, $BS_CENTER))
Global $SerialName = GUICtrlCreateLabel("Serial:", 30, 224, 70, 20)
Global $SerialData = GUICtrlCreateLabel($SerialV, 70, 224, 170, 20)
Global $ModelName = GUICtrlCreateLabel("IP:", 30, 240, 70, 20)
Global $ModelData = GUICtrlCreateLabel("", 70, 240, 170, 20)

GUICtrlCreateGroup("", -99, -99, 1, 1)
Global $ScrcpyGroup = GUICtrlCreateGroup("Scrcpy", 20, 306, 360, 49, BitOR($GUI_SS_DEFAULT_GROUP, $BS_CENTER))
Global $Resolution = GUICtrlCreateCombo("", 300, 324, 70, 25, BitOR($CBS_DROPDOWN, $CBS_AUTOHSCROLL))
...
Global $FullScreenC = GUICtrlCreateCheckbox("", 30, 324, 20, 20, BitOR($GUI_SS_DEFAULT_CHECKBOX, $BS_PUSHLIKE))
GUICtrlSetTip(-1, "Full Screen")
GUICtrlSetState($FullScreenC, $FullScreenV)
GUICtrlSetOnEvent($FullScreenC, "Param")
Global $PowerOffOnCloseC = GUICtrlCreateCheckbox("", 60, 324, 20, 20, BitOR($GUI_SS_DEFAULT_CHECKBOX, $BS_PUSHLIKE))
...
Global $AlwaysOnTopC = GUICtrlCreateCheckbox("", 90, 324, 20, 20, BitOR($GUI_SS_DEFAULT_CHECKBOX, $BS_PUSHLIKE))
GUICtrlSetTip(-1, "Always On Top")
GUICtrlSetState($AlwaysOnTopC, $AlwaysOnTopV)
GUICtrlSetOnEvent($AlwaysOnTopC, "Param")
Global $ReadOnlyModeC = GUICtrlCreateCheckbox("", 120, 324, 20, 20, BitOR($GUI_SS_DEFAULT_CHECKBOX, $BS_PUSHLIKE))
GUICtrlSetTip(-1, "Read Only Mode")
GUICtrlSetState($ReadOnlyModeC, $ReadOnlyModeV)
GUICtrlSetOnEvent($ReadOnlyModeC, "Param")
Global $ShowTouchC = GUICtrlCreateCheckbox("", 150, 324, 20, 20, BitOR($GUI_SS_DEFAULT_CHECKBOX, $BS_PUSHLIKE))
GUICtrlSetTip(-1, "Show Touch")
GUICtrlSetState($ShowTouchC, $ShowTouchV)
GUICtrlSetOnEvent($ShowTouchC, "Param")
Global $NoScreenSaverC = GUICtrlCreateCheckbox("", 180, 324, 20, 20, BitOR($GUI_SS_DEFAULT_CHECKBOX, $BS_PUSHLIKE))
GUICtrlSetTip(-1, "No Screensaver")
GUICtrlSetState($NoScreenSaverC, $NoScreenSaverV)
GUICtrlSetOnEvent($NoScreenSaverC, "Param")
Global $TurnOffTheScreenC = GUICtrlCreateCheckbox("", 210, 324, 20, 20, BitOR($GUI_SS_DEFAULT_CHECKBOX, $BS_PUSHLIKE))
...
Global $StayAwakeC = GUICtrlCreateCheckbox("", 240, 324, 20, 20, BitOR($GUI_SS_DEFAULT_CHECKBOX, $BS_PUSHLIKE))
GUICtrlSetTip(-1, "Stay Awake")
GUICtrlSetState($StayAwakeC, $StayAwakeV)
GUICtrlSetOnEvent($StayAwakeC, "Param")
Global $HideBorderC = GUICtrlCreateCheckbox("", 270, 324, 20, 20, BitOR($GUI_SS_DEFAULT_CHECKBOX, $BS_PUSHLIKE))
GUICtrlSetTip(-1, "Hide Border")
GUICtrlSetState($HideBorderC, $HideBorderV)
GUICtrlSetOnEvent($HideBorderC, "Param")
GUICtrlCreateGroup("", -99, -99, 1, 1)
Global $TouchGroup = GUICtrlCreateGroup("Touch", 20, 361, 260, 183, BitOR($GUI_SS_DEFAULT_GROUP, $BS_CENTER))
Global $ShortCutC = GUICtrlCreateRadio("", 120, 379, 20, 20, BitOR($GUI_SS_DEFAULT_RADIO, $BS_PUSHLIKE))
GUICtrlSetTip(-1, "Ctrl")
Global $ShortCutA = GUICtrlCreateRadio("", 160, 379, 20, 20, BitOR($GUI_SS_DEFAULT_RADIO, $BS_PUSHLIKE))
GUICtrlSetTip(-1, "Alt")
Global $VolumeUP = GUICtrlCreateButton("+", 30, 409, 50, 35)
GUICtrlSetTip(-1, "Volume UP")
GUICtrlSetOnEvent($VolumeUP, "TVolUP")
Global $ScreenOn = GUICtrlCreateButton("Screen On", 90, 409, 50, 35, $BS_MULTILINE)
GUICtrlSetOnEvent($ScreenOn, "TSOn")
Global $NotificationOn = GUICtrlCreateButton("Notification On", 160, 409, 50, 35, $BS_MULTILINE)
GUICtrlSetOnEvent($NotificationOn, "TNOn")
Global $Menu = GUICtrlCreateButton("Menu", 220, 409, 50, 35)
GUICtrlSetTip(-1, "Menu")
GUICtrlSetOnEvent($Menu, "TMenu")
Global $VolumeDown = GUICtrlCreateButton("-", 30, 454, 50, 35)
GUICtrlSetTip(-1, "Volume Down")
GUICtrlSetOnEvent($VolumeDown, "TVolDown")
Global $ScreenOff = GUICtrlCreateButton("Screen Off", 90, 454, 50, 35, $BS_MULTILINE)
GUICtrlSetOnEvent($ScreenOff, "TSOff")
Global $NotificationOff = GUICtrlCreateButton("Notification Off", 160, 454, 50, 35, $BS_MULTILINE)
GUICtrlSetOnEvent($NotificationOff, "TNOff")
Global $Power = GUICtrlCreateButton("Power", 220, 454, 50, 35)
GUICtrlSetTip(-1, "Power On/Off")
GUICtrlSetOnEvent($Power, "TPower")
Global $Back = GUICtrlCreateButton("<", 65, 499, 50, 35)
GUICtrlSetTip(-1, "Back")
GUICtrlSetOnEvent($Back, "TBack")
Global $Home = GUICtrlCreateButton("?", 125, 499, 50, 35)
GUICtrlSetTip(-1, "Home")
GUICtrlSetOnEvent($Home, "THome")
Global $Switch = GUICtrlCreateButton("=", 185, 499, 50, 35)
GUICtrlSetTip(-1, "Switch")
GUICtrlSetOnEvent($Switch, "TSwitch")
GUICtrlCreateGroup("", -99, -99, 1, 1)
Global $OnOFFGroup = GUICtrlCreateGroup("", 290, 361, 90, 183)
Global $On = GUICtrlCreateButton("On", 300, 376, 70, 74)
GUICtrlSetOnEvent($On, "On")
Global $Off = GUICtrlCreateButton("Off", 300, 460, 70, 74)
GUICtrlSetOnEvent($Off, "Off")
GUICtrlCreateGroup("", -99, -99, 1, 1)
Global $Parameter = GUICtrlCreateLabel("", 20, 548, 360, 39, BitOR($ES_AUTOVSCROLL, $ES_READONLY), 0)
GUICtrlSetData($Parameter, "")
GUICtrlCreateGroup("", -99, -99, 1, 1)
Global $StatusBar1 = _GUICtrlStatusBar_Create($MainGUI)
